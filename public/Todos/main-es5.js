...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      path: ':status',
      component: _todo_todo_component__WEBPACK_IMPORTED_MODULE_7__["TodoComponent"]
    }, {
      path: '**',
      redirectTo: '/all'
    }];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _todo_todo_component__WEBPACK_IMPORTED_MODULE_7__["TodoComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot(routes)],
      providers: [],
      ...
      _createClass(TodoComponent, [{
        ...
        value: function addTodo() {
          ...
          this.todoService.add({
            ...
            return _this2.getTodos();
          }).then(function () {
            _this2.newTodo = ''; // clear input form value
          });
        }
      }, {
        key: "getTodos",
        value: function getTodos() {
          ...
          return this.todoService.get(query).then(function (todos) {
            _this3.todos = todos;
            _this3.activeTasks = _this3.todos.filter(function (todo) {
              return !todo.isDone;
            }).length;
          });
        }
        ...
        key: "updateTodo",
        value: function updateTodo(todo, newValue) {
          var _this4 = this;

          todo.title = newValue;
          return this.todoService.put(todo).then(function () {
            todo.editing = false;
            return _this4.getTodos();
          });
        }
      }, {
        key: "destroyTodo",
        value: function destroyTodo(todo) {
          var _this5 = this;

          this.todoService.delete(todo).then(function () {
        ...
        value: function toggleTodo(todo) {
          ...
          this.todoService.toggle(todo).then(function () {
            return _this7.getTodos();
          });
        }
      }]);
  ...
  function srcAppTodoTodoServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(TodoService, [{
        ...
        value: function get() {
          ...
          return new Promise(function (resolve) {
            ...
            if (query === 'completed' || query === 'active') {
              ...
              data = TODOS.filter(function (todo) {
        ...
        key: "delete",
        value: function _delete(selected) {
          return new Promise(function (resolve) {
            var index = TODOS.findIndex(function (todo) {
        ...
        key: "toggle",
        value: function toggle(selected) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/Priya/Documents/github/angular-todo/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
