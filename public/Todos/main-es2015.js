...
const routes = [
    { path: ':status', component: _todo_todo_component__WEBPACK_IMPORTED_MODULE_7__["TodoComponent"] },
    { path: '**', redirectTo: '/all' }
];
...
module.exports = __webpack_require__(/*! /Users/Priya/Documents/github/angular-todo/src/main.ts */"./src/main.ts");
